    ...
    <div class="left-content">
        <div class="mother-grid-inner">
            ...
            <div class="inner-block">
                <div class="blank">
                    <h2 style="position: center">posts are here  </h2>
                    ...
                    <div>
                        ...
                        <section>
							...
							//var_dump($jaime) ;
							if ($jaime['jaime'] == 1 ) {
								$imagesrc = "images/love1.png";
							}else{
								$imagesrc = "images/love0.png";
							}
							...
							?>
                            <div id="theidofpost" style="display: none;"><?php $_GET['id'];?></div>
                            ...
                            <center>
                                <div class="blankpage-main" >
                                    <center>
                                        <h1 id=h1-bootstrap-heading""><?php echo $tab[1];?></h1>
                                    </center>
                                <article>
                                    <header>
                                    ...
                                    <footer>
                                        <hr>
                                        <h6 id="h6-bootstrap-heading">Posted by<?php echo $tab[5] ;?> <strong></strong></h6>
                                        <h6 id="h6-bootstrap-heading">Posted on<?php echo $tab[4] ;?> <time></time></h6>
                                        <div>
                        ...
                        <script>
                            function statcomments() {
                                var id =$("#theidofpost").val() ;
                                $.ajax({
                                    url: "../views/getnombredecommentaire.php",
                                    type: "GET",
                                    data : "="+id ,
                                    success: function (data) {
                                       // alert(data+"comments") ;
                                       // document.getElementById("gethenumberofcomments1").innerHTML = data ;
                                        $("#gethenumberofcomments1").find("span").text(data)  ;
                                    }
                                })
                            }
                            function statsjaime() {
                                var id =$("#theidofpost").val() ;
                                $.ajax({
                                    url: "../views/getnombredejaime.php",
                                    type: "GET",
                                    data : "="+id ,
                                    success: function (data) {
                                        //alert(data+"love") ;
                                         $("#getthenumberofinteraction1").find("span").text(data) ;
                                    }
                                })
                            }
                            $(document).ready(function () {
                        ...
                        <?php
                        $interaction234 = new interactionC() ;
                        $comments101 = new commentaireclasseC() ;
                        $nombredejaime = $interaction234->getnombredejaime($_GET['id']) ;
                        $nombredecomments = $comments101->getnumberofcomments($_GET['id']) ;
                        ?>
                        <div id="gethenumberofcomments1" style="display: none ; " ><span id="firstspan"><?php echo $nombredecomments[0]["count(*)"] ; ?></span></div>
                        <div id="getthenumberofinteraction1" style="display: none;" ><span id="secondspan"><?php echo  $nombredejaime[0]["count(*)"] ; ?></span></div>

                        <script src="../web/js/Chart.min.js"></script>

                        <div class="chart-other">
                        <h3 STYLE="text-align: center;">interaction on this post </h3>
                            <p></p>
                            <br>
                            <center>
                        <canvas  style="align-content: center ; " id="pie" height="315" width="470" style="width: 470px; height: 315px;"></canvas>
                            </center>
                        <script>
                     ...
                     <br>
                            <div style="background-color: #337AB7 ; width: 20px; }">C</div><p>comments</p>
                            <div  style="background-color: #FC8213 ; width: 20px; }">J</div><p>jaime</p>
                    </div>
                </div>
