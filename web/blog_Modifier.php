...
<div>
	...
	<section>
		...
		<hr>
		<center>
			<form class="" action="../views/modifier.php?id=<?php echo $tab[0]?>" method="post" >
				<legend>Title</legend>
				<br>
				<input type="text" name="title" value="<?php echo  $tab[1]?>">
				<br>
				<legend>sous-titre</legend>
				<br>
				<input type="text" name="title2" value="<?php echo  $tab[2]?>">
				<br>
				<legend>Post</legend>
				<br>
				...
				<legend>Image </legend>
				<br>
				<legend>Select image to change:
					<img src="<?php echo "images/imageserveur/".$tab[8] ;?>" width="600">
