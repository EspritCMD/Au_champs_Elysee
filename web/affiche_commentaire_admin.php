					...
					<div class="col-md-6 col-sm-8 col-xs-8 w3_menu">
						<div class="mini-cart">
							<ul class="icon1 sub-icon1 profile_img">
								...
								<li><a class="active-icon c1" href="#"><img src="images/cart.png" alt=""/> </a><div class="rate" id="rate">3</div>
	...
	<section>
		...
		<center>
			...
			<table style="margin-left: 100px ; margin-right: 100px ;">
				...
				$list2 = $commentaireC->affichecommetaireforconfirm() ;
		       $post = new postclassC() ;
               ...
               foreach ($AA as $key=>$value) {
                ...
                if ($list2== null) {
                    ?>
                    <center>
                        <p style="font-size: 60px">No New comment</p>
                    </center>
                    <?php
                }
				foreach ($list2 as $item) {
					...
					<td style="width: 600px">
						postedbye<br>
						<img src="images/test2.jpg" width="50x">
					</td>
					<td>
						<form action="#" method="post">
							<input type="submit" name="<?php echo $tab2['id']?>" value="submit">
                            <input type="submit" name="supprimer<?php echo $tab2['id']?>" value="supprimer">
						</form>
