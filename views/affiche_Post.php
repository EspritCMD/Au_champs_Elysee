...
<head>
	...
	<script type="application/x-javascript"> addEvent4$$AAener("load", function() { setTimeout(hideURLbar, 0); }, false);
	...
	<!-- //online-fonts -->
	<script type="application/x-javascript"> addEvent4$$AAener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
	<!-- Custom Theme files -->
			...
			<div class="container">
				...
				<div class="banner_top">
					...
					<div class="col-md-6 col-sm-4 col-xs-4 logo">
						<h1><a href="index.html">Aux Champs<span>Elysées</span></a></h1>
					</div>
					...
					<div class="col-md-6 col-sm-8 col-xs-8 w3_menu">
						<div class="mini-cart">
							<ul class="icon1 sub-icon1 profile_img">
								...
								<li><a class="active-icon c1" href="#"><img src="../web/images/cart.png" alt=""/> </a><div class="rate" id="rate">3</div>
									<ul class="sub-icon1 4$$AA">
										<h3>Recently added items(3)</h3>
										<div class="shopping_cart">
											<div class="cart_box" id ="box">
        ...
        <label style="position: center">Commentaire</label>
          ...
          <script type="text/javascript">
              function affichercomentaire() {
                  var div = "id=" + $("#domtarget").text() ;
                  $.ajax({
                          url: "affichecomentaire.php",
                          type: "GET",
                          data: div ,
                          success: function (data) {
                             var  commentshtml = "" ;
              ...
              function addcomments() {
                  var div = "id=" + $("#domtarget").text() +"&posttext=" + document.getElementById("firstcoemnt").value ;
                      //var text = "#"+ document.getElementById(str).value ;
                  if (document.getElementById("firstcoemnt").value == "") {
                      alert("comments can't be empty ") ;
                  }else{
                      $.ajax({
                          url: "add_commentaure.php",
                          type: 'GET',
                          data: div,
                          success: function () {
              ...
              function addmorecomments() {
                  var div = "id=" + $("#domtarget").text() +"&posttext=" + document.getElementById("textofcoments").value ;
                  //var text = "#"+ document.getElementById(str).value ;
                 if (document.getElementById("textofcoments").value == "") {
                     alert("comments can't be empty ") ;
                 }else {
                  $.ajax({
                      url : "add_commentaure.php" ,
                      ...
                      data : div ,
                      success : function () {
                          alert("it's done ... waiting for admin apprrouve ") ;
                      }
                  })
                 }
              }
              function modifiercomentaire(idpost) {

                  var div = "id=" +idpost+"&message="+ document.getElementById("textofcoments").value ;
                  if (document.getElementById("textofcoments").value == "") {
                      alert("write something to change comments") ;
                  }else {
                      $.ajax({
                          url : "modifiercomentaire.php" ,
                          type : 'GET' ,
                          data : div ,
                          success : function (data) {
              ...
              function supprimercommetaire(id) {
                  var id = "id="+id ;
                  if (confirm('do you want to delete that message ? ')){
                      $.ajax({
                          url : "deletecommentaire.php" ,
                          type : 'GET' ,
                          data : id ,
                          success : function (data) {
                              affichercomentaire() ;
