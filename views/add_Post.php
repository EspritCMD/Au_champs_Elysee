		...
		<div class="mother-grid-inner">
			...
			<div class="inner-block">
				<div class="blank">
					...
					if (strlen( $_POST["post"]) > 900) {
						echo "your post is more than 900 cractere " ;
						...
						if (!empty($PostC)) {
							...
							echo "you have added your post avec succes <br>";
		...
		<ul id="menu" >
			...
			<li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Stories</span><span class="fa fa-angle-right" style="float: right"></span></a>
				<ul id="menu-comunicacao-sub" >
					<li id="menu-mensagens" ><a href="../web/blank.html">Add Stories</a></li>
			...
			<li><a href="#"><i class="fa fa-cog"></i><span>System</span><span class="fa fa-angle-right" style="float: right"></span></a>
				<ul id="menu-academico-sub" >
					...
					<li id="menu-academico-boletim" ><a href="../web/blank.html">Blank</a></li>
				</ul>
			</li>
